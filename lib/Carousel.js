...
var Carousel = function (_Component) {
	...
	_createClass(Carousel, [{
		...
		value: function activateByKey(key, e) {
			var itemsCount = this.props.data.length;
			this.setState({
...
process.env.NODE_ENV !== "production" ? Carousel.propTypes = {
	...
	propLabel: _propTypes2.default.string,
	propValue: _propTypes2.default.string,
	children: _propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.array]),
	changeHeightAfterSwipe: _propTypes2.default.bool,
	handleSwitch: _propTypes2.default.func,
	activeKey: _propTypes2.default.number,
	resetKey: _propTypes2.default.bool
} : void 0;
