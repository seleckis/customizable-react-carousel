	...
	_createClass(List, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    restProps = _objectWithoutProperties(_props, ['container', 'component', 'items', 'activeKey', 'slideStyle']);
			...
			return Container ? _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ index: activeKey, onChangeIndex: this.handleChangeIndex, slideStyle: slideStyle },
